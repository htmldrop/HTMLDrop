...
Create a new folder in `content/plugins/` with an `index.mjs` file:
...
See the [Scheduler Documentation](../../core/docs/development/SCHEDULER.md) for complete details.
...
2. **Manually:**
   - Place your plugin folder in `content/plugins/`
