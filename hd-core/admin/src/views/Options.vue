<template>
  ...
  <div class="container" v-else>
    <div class="header-section">
      ...
      <router-link class="add-button" :to="'/settings/new'">{{ translate('Add') }} {{ translate('setting')?.toLowerCase() }}</router-link>
    </div>
      ...
      <div class="filters">
        <div class="filters-section">
          <select v-model="action">
            ...
            <option value="delete">{{ translate('Permanently delete') }}</option>
      ...
      <div class="table">
        ...
        <div class="body">
          <div v-for="item in response?.items || []" :key="item.id" class="row">
            ...
            <div class="actions-cell sticky-left">
              <router-link class="button" :to="'/settings/' + (postTypeFields?.some(f => f.field?.slug === 'slug') ? item.slug : item.id)">{{ translate('Open') }}</router-link>
