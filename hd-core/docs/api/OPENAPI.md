...
The OpenAPI configuration is located in `/hd-core/config/swagger.mjs`. You can customize:
...
1. Add OpenAPI annotations to all controller files in `/hd-core/controllers/v1/`
2. Update schemas in `/hd-core/config/swagger.mjs` as needed
