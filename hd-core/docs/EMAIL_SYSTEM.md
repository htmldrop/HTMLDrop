...
Templates are located in [hd-core/templates/emails/](../templates/emails/).
...
Run tests:
```bash
npm run test -- hd-core/tests/services/EmailService.test.mjs
npm run test -- hd-core/tests/services/PasswordResetService.test.mjs
npm run test -- hd-core/tests/registries/RegisterEmailProviders.test.mjs
```
