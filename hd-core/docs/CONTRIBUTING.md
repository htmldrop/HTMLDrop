...
import app from '../../hd-core/app.mjs'
import knex from '../../hd-core/database/knex.mjs'
...
- Update [docs/api/README.md](hd-core/docs/api/README.md) for API changes
- Include request/response examples
- Document all query parameters and headers

### Architecture Documentation

- Update [docs/architecture/README.md](hd-core/docs/architecture/README.md) for architectural changes
