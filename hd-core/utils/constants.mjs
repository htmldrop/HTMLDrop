...
export const PATHS = {
  CONTENT_DIR: './hd-content',
  PLUGINS_DIR: './hd-content/plugins',
  THEMES_DIR: './hd-content/themes',
  UPLOADS_DIR: process.env.UPLOAD_DIR || './hd-content/uploads',
  CONFIG_DIR: './hd-content/config',
  LOGS_DIR: './logs',
  TEMP_DIR: './hd-content/.temp',
  BACKUPS_DIR: './hd-content/.backups'
}
